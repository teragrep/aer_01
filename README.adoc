...
* Implements https://github.com/teragrep/akv_01[AKV_01] and https://github.com/teragrep/nlf_01[NLF_01] libraries for additional syslog message processing based on `resourceId` from events received from EventHub.
